...
PGL.DIALOG.accountPublish = function()
{
	PGL.REQUEST.postAPI("GET_ACCOUNT_PUBLISH",{}).done(function(data)
	{
		...
		var page1Tags = function()
		{
			...
			[
				'<ul class="clearFix">',
					'<li class="floatR font12 fontB"><a href="/support/" class="iconHelp_or">',PGL.UTIL.getLocale("GLOSSARY_ABOUT_PRIVACY_SETTINGS"),'</a></li>',
				'</ul>',
...
PGL.DIALOG.selectGameId = function(data)
{
	var page1Tags = function()
	{
		...
		var btn = (data.savedataList.length==1)? 
			'<p class="alingC mt20"><a href="/register/add/" class="btnGrLarge">'+PGL.UTIL.getLocale("GLOSSARY_ACTION_ADD_GAME_CARD")+'</a></p>':"";
